...
@Component
public class UseCaseService implements UseCaseRunner{
...
//    private IIntegracao integracaoService;
    ...
    private IUseCase getUseCaseBean(UseCaseMapper mediator) {
        return context.getBean(mediator.getMediator().getClass());
    }
